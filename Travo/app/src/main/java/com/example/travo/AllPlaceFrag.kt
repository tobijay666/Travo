...
class AllPlaceFrag : Fragment() {
   ...
   // private lateinit var placeDetailsArrayList: ArrayList<PlaceDetails>
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_all_place, container, false)
        ...
        btnHotel.setOnClickListener {
            ...
            val allHotelFrag=AllHotelFrag()
            fragmentManager?.beginTransaction()?.replace(R.id.fragContainer,allHotelFrag)?.commit()
        }
        searchItems()
        setPlaceData()
