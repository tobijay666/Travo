...
class HotelFrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        //clickLocation=intent.getStringExtra("location").toString()
        ...
        btnPlace.setOnClickListener {
            /*val intent= Intent(this, PlaceAct::class.java)
            ...
            fragmentManager?.beginTransaction()?.replace(R.id.fragContainer,placeFrag)?.commit()
        }
    ...
    private fun setHotelData() {
        ...
        try {
            ...
            db.collection("Hotel").whereEqualTo("location",clickLocation)
